...
EdiFile.prototype.fieldsToString = function (properties, fields) {
	...
	_.each(
		...
		function (field) {
			...
			if (field.type == "string") {
				...
				fieldContent =
				typeof properties[field.name] === "string" && field.name.toLowerCase() !== "filler" ?
					properties[field.name].padStart(field.name.len,"0") : properties[field.name] +
					new Array(
						numberOfCharacters - properties[field.name].toString().length + 1
					).join(" ");
				...
				fieldContent =
					...
					console.log("edipsy fieldContent ", fieldContent);
					console.log("edipsy field ", field);
					console.log("edipsy properties[field.name] ", properties[field.name]);
			} else if (field.type == "date") {
	...
	console.log("edipsy fieldsToString ",line);
